...
class DefinitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create definition" do
    assert_difference('Definition.count') do
      post definitions_url, params: { definition: { definition: @definition.definition, title: @definition.title } }
    end
  ...
  test "should update definition" do
    patch definition_url(@definition), params: { definition: { definition: @definition.definition, title: @definition.title } }
