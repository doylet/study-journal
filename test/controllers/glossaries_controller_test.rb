...
class GlossariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create glossary" do
    assert_difference('Glossary.count') do
      post glossaries_url, params: { glossary: { Definition: @glossary.Definition, Title: @glossary.Title, courses: @glossary.courses } }
    end
  ...
  test "should update glossary" do
    patch glossary_url(@glossary), params: { glossary: { Definition: @glossary.Definition, Title: @glossary.Title, courses: @glossary.courses } }
